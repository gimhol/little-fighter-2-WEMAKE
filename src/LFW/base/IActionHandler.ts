...
import type { IAction_NextFrame, IAction_SetProp, IAction_Sound } from "../defines";
...
interface IActionPayload extends IActionPayloadBase {
  ...
  [ActionType.A_NEXT_FRAME]: IAction_Defend | IAction_BrokenDefend | IAction_NextFrame;
  ...
  [ActionType.V_NEXT_FRAME]: IAction_Defend | IAction_BrokenDefend | IAction_NextFrame;
