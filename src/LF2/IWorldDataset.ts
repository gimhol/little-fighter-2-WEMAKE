...
export const world_dataset_fields = fields<Partial<IWorldDataset>>({
  ...
  catch_time_max: float,
  defend_value_max: float,
  defend_ratio: float,
  mp_max: float,
  hp_max: float,
  resting_max: float,
  ...
  jump_height: float('跳越Y速度'),
  jump_distance: float('跳越X速度'),
  jump_distancez: float('跳越Z速度'),
  dash_height: float,
  dash_distance: float,
  dash_distancez: float,
  rowing_height: float('受身Y速度'),
  rowing_distance: float('受身X速度'),
