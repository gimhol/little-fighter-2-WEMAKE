 ...
 * @extends {UIComponent}
 */
export class SlotSelLogic2 extends UIComponent {
  static override readonly TAG = "SlotSelLogic2";
  ...
  readonly fsm = new FSM<SlotSelStatus, IStateUnit>().add({
    ...
    on_player_key_down: (e) => {
      if (this.player_id != e.player) return;
      if (e.game_key === 'a') {
  ...
  get max_player(): number { return 8 }
