...
const names = Array.from(COLOR_HEX_MAP.keys());
for (const name of names) {
  const value = COLOR_HEX_MAP.get(name)
  if (value == void 0) continue;
  COLOR_HEX_MAP.set(name.toUpperCase(), value)
  COLOR_HEX_MAP.set(name.toLowerCase(), value)
}
